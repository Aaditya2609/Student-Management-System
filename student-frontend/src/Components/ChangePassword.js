...
export default class ChangePassword extends Component {
    ...
    checkOldPassword = (e) => {
        ...
        if (this.state.oldPassword) {
            ...
            FacultyService.findFaculty(this.state.id).then((response) => {
    ...
    changePassword = (e) => {
        ...
        if (this.state.validPassword) {
            this.setState({ showLoader: true })
            FacultyService.changePassword(this.state.id, this.state.oldPassword, this.state.newPassword).then((response) => {
